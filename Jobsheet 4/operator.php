...
$jmlKursiKosong = $jmlKursi - $kursiDitempati;
$presentaseKursi = ($jmlKursiKosong / $jmlKursi) * 100;

echo "Jumlah kursi yang ada direstoran: $jmlKursi <br>";
echo "Jumlah kursi yang sudah ditempati: $kursiDitempati <br>";
echo "Persentase kursi yang masih kosong adalah $presentaseKursi%";
?>